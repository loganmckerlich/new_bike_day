...
def main() -> None:
    ...
    st.markdown("""
    The verdict is in...
    Yes, one of these bikes edges out the other and maybe we were able to find that edge using data.
    But the numbers don't catch it all. At the end of the day the best bike is the one you're riding.
    So go back, manipulate the data cleaning step until your favorite bike comes out on top,
    and then go ride it.
    ...
    I can be reached via my personal website which I'll link below. 
    You can also see other projects I have worked on /plan to work on there.
    """)
